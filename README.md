...
| 11	| /	| D0/RX	| PROTO: no	| no (IND.I/O: used by RS485)|
| 12	| /	| D1/TX	| PROTO: no	| no (IND.I/O: used by RS485)|
| 13	| /	| D2/SDA	| PROTO: no	| no (IND.I/O: used for I2C)|
| 14	| /	| D3/SCL |	PROTO: no	| no (IND.I/O: used for I2C)|
